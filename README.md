...
3.  **Modeling:** The AI constructed a Python simulation using `scipy` and `numpy` to fit a Gaussian Mixture Model against specific "anchors" (e.g., the "Herron Limit" for maximum possible mileage).
...
*   **`requirements.txt`**: The Python environment dependencies used to run the simulation.
